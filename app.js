...
function showAdhyayaList(){closeSidebar();showView('view-adhyaya-list');setNavActive('nav-home');_pushHist({type:'adhyaya-list'});}
...
function showVyakhya(){
  closeSidebar();showView('view-vyakhya');setNavActive('nav-vyakhya');document.getElementById('main').scrollTop=0;_pushHist({type:'vyakhya'});
...
function showInstall(){closeSidebar();showView('view-install');setNavActive('nav-install');document.getElementById('main').scrollTop=0;_pushHist({type:'install'});}
function showAbout(){closeSidebar();showView('view-about');setNavActive('nav-about');document.getElementById('main').scrollTop=0;_pushHist({type:'about'});}
function showFeedback(){closeSidebar();showView('view-feedback');setNavActive('nav-feedback');document.getElementById('main').scrollTop=0;_pushHist({type:'feedback'});}
...
if('serviceWorker' in navigator){
  ...
  // Also detect if a SW update happened between page loads
